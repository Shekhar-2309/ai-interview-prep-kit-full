  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <h1 className="font-mono text-2xl font-semibold text-ink mb-1">Sign in</h1>
        <p className="text-ink-faint text-sm mb-8">Pick up where you left off.</p>
        ...
        <p className="text-sm text-ink-faint mt-6">
          No account yet?{" "}
          <Link href="/register" className="text-pen underline">
            Create one
          </Link>
        </p>
      </div>
